...
public class LoanIntegrationTest {
    private static final String VLADI = "Vladi";
    ...
    public void givenLoanRequestIsMadeLoanApplicationGetsCreated() throws Exception {
        ...
        assertEquals(loanApplicationDTOS.get(0).getBorrower().getUsername(), VLADI);
    }

    private HttpHeaders getHttpHeaders() {
        HttpHeaders httpHeaders = new HttpHeaders();
        httpHeaders.add(HttpHeaders.AUTHORIZATION, VLADI);
        return httpHeaders;
    }
}

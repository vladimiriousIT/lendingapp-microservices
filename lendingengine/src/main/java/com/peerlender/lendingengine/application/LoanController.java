...
import com.peerlender.lendingengine.application.service.LoanApplicationAdapter;
import com.peerlender.lendingengine.application.service.LoanService;
...
public class LoanController {
    ...
    public void requestLoan(@RequestBody final LoanRequest loanRequest,
                            HttpServletRequest request) { //maps the request to the LoanRequest object
